...
function MemberIntroduction({ role, name, p, src, alt, courses}) {
    return (
        <div className={`${aboutUsStyle.memberCard} ${masterStyle.flexRow}`}>
            ...
            <div className={`${aboutUsStyle.memberCardRight} ${masterStyle.flexColumn}`}>
                <div className={`${aboutUsStyle.memberCardRightTop} ${masterStyle.flexRow}`}>
                    <h2 className={`${masterStyle.headingText}`}>{role}</h2>
                    <div className={masterStyle.flexRow}>
                        <SecondaryLinkButton href={'#'} text={'CEH'} />
                        <SecondaryLinkButton href={'#'} text={'eWPT'} />
                        <SecondaryLinkButton href={'#'} text={'CISSP'} />
                    </div>
                </div>
                <p className={`${masterStyle.normalText}`}>{p}</p>
                <div className={`${aboutUsStyle.socialLinks} ${masterStyle.flexRow}`}>
                    <a href=""><img src="src/assets/Social Icons/linkedin-logo.png" alt="F" /></a>
                    <a href=""><img src="src/assets/Social Icons/github-logo.png" alt="F" /></a>
                    <a href=""><img src="src/assets/Social Icons/twitter-logo.png" alt="F" /></a>
                </div>
            </div>
        </div>
    );
